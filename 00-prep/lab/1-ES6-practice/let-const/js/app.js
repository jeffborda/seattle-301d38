...
function displayPics(){
  ...
  // We got this error on the variable "rando" because it is declared inside the while loop of the funciton.  Since let is block scope, the variable does not carry outside of that block.
